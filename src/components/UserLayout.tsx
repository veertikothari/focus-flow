            ...
            <div className="flex h-16 items-center justify-center border-b md:border-none relative">
              <img
                ...
                className={`h-10 w-10 transition-opacity duration-300 ease-in-out ${
                  isHovered || sidebarOpen ? 'opacity-0 absolute invisible' : 'opacity-100'
                }`}
              />
              <h1
                className={`text-xl font-bold text-gray-900 transition-opacity duration-300 ease-in-out ${
                  isHovered || sidebarOpen ? 'opacity-100' : 'opacity-0 absolute invisible'
                }`}
              >
                User Panel
              </h1>
                ...
                return (
                  <div key={item.name} className="relative group">
                    ...
                    >
                      ...
                      <span
                        className={`ml-10 transition-opacity duration-300 ease-in-out ${
